...
# Prerequists
Make sure you have the latest nodejs recommended version installed 
...
## Instructions from Stefano
To login to expo: `expo login`

- username/email: puggummobileapp@gmail.com
- password: Passwordsmtg!1

For the first time run `npm install`

`npm run start` you will get a barcode, scan it with your phone
